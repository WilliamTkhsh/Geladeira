...
sucoMaracuja = Item('Suco de Maracuja', '6,00', os.path.join(app.config['UPLOAD_FOLDER'], 'suco_maracuja.jpg'))
sucoPesssego = Item('Suco de Pêssego', '6,00', os.path.join(app.config['UPLOAD_FOLDER'], 'suco_pessego.jpg'))
redBull = Item('Red Bull', '10,00', os.path.join(app.config['UPLOAD_FOLDER'], 'red_bull.jpg'))
redBullZero = Item('Red Bull Zero', '10,00', os.path.join(app.config['UPLOAD_FOLDER'], 'red_bull_zero.jpg'))
monster = Item('Monster', '10,00', os.path.join(app.config['UPLOAD_FOLDER'], 'monster.jpg'))
